...
{
  Book* pub= new Book (isbn_, author_, prodName_, price_, qty_, categoryID()); 
  return pub;
...
{
  Clothing* piece= new Clothing (size_, brand_, prodName_, price_, qty_, "clothing");
  return piece; 
...
{
  Movie* film= new Movie (genre_, rating_, prodName_, price_, qty_, "movie");
  return film;
